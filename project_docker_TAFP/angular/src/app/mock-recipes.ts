...
export const MOCK_RECIPES: RecipeModel[] = [
  {
    ...
    imgUrl: 'https://placehold.jp/30/dddd00/ffffff/300x200.png?text=Spaghetti Carbonara',
    ingredients: [
  ...
  },
  {
    ...
    imgUrl: 'https://placehold.jp/30/00dd00/ffffff/300x200.png?text=Caprese Salad',
    ingredients: [
